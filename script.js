...
const gameSlugs = [
  'Abiotic_Factor', 'Art_Of_Rally', 'Blood_Vial', 'Caravan_Sandwitch', 'Fez', 'Firewatch', 'For_The_King', 'Friends_vs_Friends', 'Fumes', 
  'Gris', 'Inscryption', 'Journey', 'Judofuri', 'Kena_Bridges_of_Spirits', 'Lil_Gator_Game', 'Lost_In_Random', 
  'Meccha_Chameleon', 'Mika_and_the_Mountain_Witch', 'Murky_Divers', 'No_Rest_For_The_Wicked', 'Outer_Wilds', 'Pit_Of_Goblin', 'Poco', 'Prince_of_Persia_The_Forgotten_Sands', 'Prince_of_Persia_The_Sands_of_Time',
