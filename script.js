...
const gameSlugs = [
  'Caravan_Sandwitch', 'Inscryption', 'Mika_and_the_Mountain_Witch', 'Poco', 'Prince_of_Persia_The_Forgotten_Sands', 'Prince_of_Persia_The_Sands_of_Time', 'Wizard_With_A_Gun',
];
